...
public class ProductionBean {
	 ...
	 */
	public void allowForUser(UserLogon logon, String productSysname, String login, boolean isAllowed, boolean autocreate) throws CarabiException {
		...
		allowForUser(logon, product, user, isAllowed, autocreate);
	}
	 ...
	 * @throws ru.carabi.server.CarabiException
	 */
	public void allowForUser(UserLogon logon, SoftwareProduct product, CarabiUser user, boolean isAllowed, boolean autocreate) throws CarabiException {
